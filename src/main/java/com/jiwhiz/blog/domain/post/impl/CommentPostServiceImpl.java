...
public class CommentPostServiceImpl implements CommentPostService {
    ...
    @Inject
    public CommentPostServiceImpl(CommentPostRepository commentPostRepository, CounterService counterService) {
    ...
    public CommentPost postComment(UserAccount user, BlogPost blogPost, String content) {
        ...
        logger.debug(String.format("Add comment to blog (blogId='%s'), by %s (userId='%s'.", blogPost.getPostId(),

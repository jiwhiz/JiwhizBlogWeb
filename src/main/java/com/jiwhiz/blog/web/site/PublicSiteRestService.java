...
/**
 * RESTful Service for public contact or profile page.
 * Also for retrieving current user info.
 * 
 * <p>API: 'rest/public/currentUser' - get current logged in user info
 * <p>API: 'rest/public/profile/:userId' - get user public profile
 * <p>API: 'rest/contact' - send contact message
 * 
 * @author Yuan Ji
 *
 */
...
public class PublicSiteRestService extends AbstractRestController {
    ...
    public @ResponseBody CurrentUser getCurrentUserAccount() {
    ...
    public UserAccountDTO getUserProfile(@PathVariable("userId") String userId) {
        ...
        List<CommentPost> comments = commentPostRepository.findByAuthorKeyAndStatus(
                account.getKey(), CommentStatusType.APPROVED, new Sort(Direction.DESC, "createdTime"));

 ...
 * 
 * <p>API: '<b>rest/myAccount/blogs/{blogId}/comment</b>'</p>
 * 
 * @author Yuan Ji
 *
 */
...
public class BlogCommentRestService extends AbstractRestController {
    ...
    @ResponseBody
    public CommentPostDTO postComment(@PathVariable("blogId") String blogId,
